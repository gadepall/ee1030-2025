...
\begin{align}
 \overrightarrow{OA} = \myvec {4\\0 }
 \overrightarrow{OB} = \myvec {0\\-3}
\end{align}

 Since $\vec{C}$ is opposite to $\vec{O}$ in the rectangle,
 
 \begin{align}
\overrightarrow{OC} = \overrightarrow{OA} + \overrightarrow{OB}=\myvec{4\\0}+ \myvec{0\\-3}=\myvec{4\\-3}
 \end{align}
\begin{align}
\therefore \vec{C}=\myvec{4\\-3}
\end{align}

We know that the length of the diagonal vector is magnitude of the vector $\overrightarrow{OC}$.\\
Let $\vec{P}=\overrightarrow{OC}$
\begin{align}
\vec{P}= \myvec{4 \\ -3} 
\end{align}

\begin{align}
\left|\vec{P} \right| &= \sqrt{ \vec{P}^T \cdot \vec{P}}
 \end{align}
 \begin{align}
     \vec{P}^T= \myvec{4 & -3} 
 \end{align}    
\begin{align}
      \vec{P}^T \cdot \vec{P}=\myvec{4 & -3}\myvec{4 \\ -3} = 4^2 + (-3)^2 = 16 + 9 = 25
\end{align}
\begin{align}  
      \left|\vec{P}\right| &= \sqrt{25} = 5 
 \end{align}
 \begin{center}
