...
\begin{equation}
    Let \; \vec{P} = a\myvec{1 \\ 0 \\ 1} + a\myvec{0 \\ -2 \\ 0}
\end{equation}

From Equations 0.6 and 0.12
\begin{align}
   a^2 \left[\myvec{1 & 0 & 1} + \myvec{0 & -2 & 0}\right] \left[\myvec{1 \\ 0 \\ 1} + \myvec{0 \\ -2 \\ 0}\right] &= 1 \\ 
   a^2\left[ 1 + 2 + 2 + 1 \right] = 6a^2 &= 1\\
