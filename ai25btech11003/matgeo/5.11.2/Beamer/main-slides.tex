...
\begin{frame}[fragile]
    \frametitle{Theoretical Solution}
 Let $\vec{M} = \myvec{-7 & 2 & 1 \\ 2 & -4 & 2 \\ -1 & -2 & 7}$ and $\vec{I} = \myvec{I_1 \\ I_2 \\ I_3}$ and $\vec{T} = \myvec{-10 \\ -5 \\ 10}$\\\\

\begin{equation}
    \therefore \, \vec{M}\vec{I}=\vec{T}
\end{equation}
...
\begin{equation}
    \myvec{-7 & 2 & 1 \\ 2 & -4 & 2 \\ -1 & -2 & 7}\vec{I} = \myvec{-10 \\ -5 \\ 10}
\end{equation}
