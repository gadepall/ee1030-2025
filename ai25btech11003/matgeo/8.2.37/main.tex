...
\begin{equation}
\frac{3}{4}x^2 + y^2 + \frac{3}{2}x - \frac{9}{4} = 0
\end{equation}


\begin{equation}
\boxed{3x^2 + 4y^2 + 6x - 9 = 0}
\end{equation}
...
\begin{equation}
    \boxed{\dfrac{(x+1)^2}{4} + \dfrac{y^2}{3} = 1}
\end{equation}
...
Putting Values of $\vec{V}, \, \vec{u}$, f in Equation 0.1, we get
\begin{equation}
-\frac{5}{4}x^2 + y^2 - \frac{45}{2}x - \frac{225}{4} = 0
\end{equation}
...
\begin{align}
    \boxed{\dfrac{(x+9)^2}{36} - \dfrac{y^2}{45} = 1}
\end{align}
...
$$\dfrac{(x+9)^2}{36} - \dfrac{y^2}{45} = 1$$
$$y^2 = 8(x + 3)$$
$$\dfrac{(x+1)^2}{4} + \dfrac{y^2}{3} = 1$$
