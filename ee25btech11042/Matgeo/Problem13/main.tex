...
\begin{document}
	...
	We need to convert the conic equation to its standard form.
	\begin{align*}
	...
	\end{align}
	The major axis corresponds to smaller eigenvalue. Since $1/16 < 1/9$, the major axis is along the y-axis.
	\begin{align}
	...
	\end{align}
	\begin{align}
		e &= \sqrt{1 - \frac{\lambda_1}{\lambda_2}} = \sqrt{1 - \frac{1/16}{1/9}} = \frac{\sqrt{7}}{4} \\
		...
		L &= \frac{-2f}{\lambda_2}\sqrt{\frac{\lambda_1}{-f}} = \frac{-2(-1)}{1/9}\sqrt{\frac{1/16}{-(-1)}} = \frac{9}{2}
	\end{align}
	...
	\begin{align}
		...
		\vec{d} &: \vec{e_2}^\top\vec{x} = \pm \frac{16}{\sqrt{7}} \implies \myvec{0 & 1}\vec{x} = \pm \frac{16}{\sqrt{7}}
	\end{align}
	\begin{center}
		\begin{tabular}{|l|c|}
			\hline
