...
\begin{document}
	...
	\begin{align}
		...
		\norm{\vec{a}\times\vec{b}} = \norm{\vec{a}}\norm{\vec{b}}|\sin(\theta)|\\
		\implies\frac{1}{2}\norm{\vec{a}}\norm{\vec{b}}\sin(90\degree) &= 5   \\
		\implies\frac{1}{2} \left(\sqrt{c_2^2+0^2}\right) \left(\sqrt{0^2+(c_2/5)^2}\right) (1) &= 5   \\
		\implies\frac{1}{2} |c_2| \left|\frac{c_2}{5}\right| &= 5   \\
		\implies\frac{|c_2^2|}{10} &= 5  \\
