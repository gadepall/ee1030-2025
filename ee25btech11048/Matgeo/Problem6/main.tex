...
\begin{align}
    \vec{n}^T \vec{x} = c
\end{align} 
    We get the line equation on solving \[\myvec{A&B}^Tn=c\myvec{1\\1}\] 
...
&\myvec{1 & \frac{1}{3} & \big| & \frac{1}{3} \\
         0 & 0 & \big| & -2 }
\end{align}
By the assumption that line equation is nTx=1 which doesn't pass through origin we are not getting any solution.So our assumption is wrong and origin lies on the line . 
