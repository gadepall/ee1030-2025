...
\end{align}
let $\brak{\vec{D}\vec{N}'}_{i,j}$ be the entry of $i$th column and $j$th row of the matrix $\vec{D}\vec{N}'$.  As $\vec{D}$ is a diagonal matrix
\begin{align}
    \brak{\vec{D}\vec{N}'}_{i,j}=\vec{D}_i\vec{N}'_{i,j}
\end{align}
let $\brak{\vec{N}'\vec{D}}_{i,j}$ be the entry of $i$th column and $j$th row of the matrix $\vec{N}'\vec{D}$.  As $\vec{D}$ is a diagonal matrix
\end{frame}

\begin{frame}{Solution}
\begin{align}
    \brak{\vec{N}'\vec{D}}_{i,j}=\vec{D}_j\vec{N}'_{i,j}\\
    \implies \brak{\vec{D}_i + \vec{D}_j}\vec{N}'_{i,j}=3\brak{\vec{I}}_{i,j}
\end{align}
for $i\neq j$
\begin{align}
     \brak{\vec{D}_i + \vec{D}_j}\vec{N}'_{i,j}=0\\
   \implies  \vec{N}'_{i,j}=0
\end{align}
for $i=j$
\begin{align}
     \brak{\vec{D}_i + \vec{D}_j}\vec{N}'_{i,j}=3\\
     \implies \vec{N}'_{i,j}=\frac{3}{2D_i}
\end{align}
$\implies$ The diagonal values of $\vec{N}'$ are $\frac{3}{2}$ and $\frac{3}{4}$ and $\frac{1}{2}$\\
In  (0.11) $\vec{Q}$ is an orthogonal matrix and $\vec{N}'$ is a daigonal matrix so we can say that (11) is the eigenvalue decomposition of $\vec{N}$\\
$\implies \vec{N}=\vec{QN}'\vec{Q}^\top$
\end{frame}
