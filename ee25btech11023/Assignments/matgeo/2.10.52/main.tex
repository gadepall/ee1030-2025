...
From \brak{3}  
\begin{align}
\frac{|\vec{r}^\top\vec{c}|}{\sqrt{3}} = \frac{1}{\sqrt{3}} \implies |\vec{r}^\top\vec{c}|=1 \\
\vec{a}^\top\vec{c}=\myvec{1&2&1}\myvec{1\\1\\-1}=1+2-1=2 
\end{align}
\begin{align}
\vec{b}^\top\vec{c}=\myvec{1&-1&1}\myvec{1\\1\\-1}=1-1-1=-1
\end{align}
Substitute \brak{11},\brak{12},\brak{13} in \brak{8} \\
If $\vec{r}^\top\vec{c}=1,$Then
\begin{align}
t=\frac{1-2}{-1}=\frac{-1}{-1}=1 \implies \vec{r}=\vec{a}+\vec{b}=\myvec{1\\2\\1}+\myvec{1\\-1\\1}=\myvec{2 \\ 1 \\2}
\end{align}
If $\vec{r}^\top\vec{c}=-1,$Then
\begin{align}
t=\frac{-1-2}{-1}=\frac{-3}{-1}=3 \implies  \vec{r}=\vec{a}+3\vec{b}=\myvec{1\\2\\1}+3\myvec{1\\-1\\1}=\myvec{4 \\ -1 \\4}
\end{align}
