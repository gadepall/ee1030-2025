...
\end{align}
   ...
   \end{align}
   Now consider Scalar triple product of $\vec{a}$,$\vec{c}$ and $\vec{b}$\\
   \begin{align}
   (\vec{a}\times\vec{c}) \cdot \vec{b}=\|\vec{b}\|^2=2
   \end{align}
   \begin{align}
   (\vec{a}\times\vec{c}) \cdot \vec{b}=\det \myvec{1&3-2\lambda&0 \\ 1&\lambda&1 \\1&\lambda&-1}=2
   \end{align}
   \begin{align}
     6-6\lambda=2\\
     \lambda=\frac{2}{3}
