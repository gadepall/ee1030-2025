...
\end{align}
Let $\vec{{b}_1}= k\vec{a}$ (where k is any scalar multiple)
    \begin{align}
                     \vec{{b}_1} = \myvec{
                                             2k
                                              \\
...
\end{align}
taking scalar product with $\vec{a}$ on both sides
\begin{align}
    \vec{b}\vec{a^T}=\vec{{b}_1}\vec{a^T}+\vec{{b}_2}\vec{a^T}
\end{align}
\end{frame}
\begin{frame}{Solution}
 As $\vec{{b}_2}\vec{a^T}=0$  \\
And $\vec{{b}_1}= k\vec{a}$
\begin{align}
18=9k\\
k=2\\
