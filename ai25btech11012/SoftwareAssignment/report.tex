...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{/Users/unnathi/Desktop/re-einstein.png}
    \caption{ }
    \label{fig:original_image}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{/Users/unnathi/Desktop/re-grescale.png}
    \caption{ }
    \label{fig:original_image}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{/Users/unnathi/Desktop/re-globe.png}
    \caption{ }
    \label{fig:original_image}
\end{figure}
