...
\frametitle{Solution}
\begin{align}
\overrightarrow{A} &= \vec{2\\6}, \quad 
\overrightarrow{B} = \vec{5\\-4}, \quad
\overrightarrow{C} = \vec{k\\4}
\end{align}

\begin{align}
\overrightarrow{B}-\overrightarrow{A} &= \vec{3\\-10}, \qquad
\overrightarrow{C}-\overrightarrow{A} = \vec{k-2\\-2}
\end{align}
...
$
35=\frac{1}{2}\left|\vec{3\\-10}\times\vec{k-2\\-2}\right|
$
\end{frame}
