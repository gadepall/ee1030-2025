...
\begin{frame}
\frametitle{Question}
The plane $2x - 3y + 6z - 11 = 0$ makes an angle $\sin^{-1}\alpha$ with the $x$-axis.  
...
\frametitle{Solution}
\begin{align}
\overrightarrow{n} &= \myvec{2,-3,6}, \quad \text{(normal vector)} \\
\overrightarrow{a} &= \myvec{1,0,0}, \quad \text{(direction vector of x-axis)}
\end{align}

\begin{align}
\cos\phi &= \frac{\vec{n}\cdot\vec{a}}{\|\vec{n}\|\|\vec{a}\|} \\
